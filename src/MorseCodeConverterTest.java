...
public class MorseCodeConverterTest {
	...
	public void testConvertToEnglishString() {	
		...
		String converter3 = MorseCodeConverter.convertToEnglish
				(".--. .- .-. - / --- ..-. / - .... . / .--- --- ..- .-. -. . -.-- / .. ... / - .... . / . -. -..");
		assertEquals("part of the journey is the end",converter3);


		String converter4 = MorseCodeConverter.convertToEnglish
				(".--. . .-. ..-. . -.-. - .-.. -.-- / -... .- .-.. .- -. -.-. . -.. / .- ... / .- .-.. .-.. / - .... .. -. --. ... / ... .... --- ..- .-.. -.. / -... .");
		assertEquals("perfectly balanced as all things should be", converter4);
	}
	...
	public void testConvertToEnglishFile() throws FileNotFoundException {
		...
		String test4="love looks not with the eyes but with the mind";
		getFile("LoveLooksNot.txt");
		String converter4 = MorseCodeConverter.convertToEnglish(inputFile);
		assertEquals(test4,converter4);
